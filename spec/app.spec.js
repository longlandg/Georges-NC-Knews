...
describe("/", () => {
  ...
  describe("/badroute", () => {
    it("statuscode: 404 with appropriate message", () =>
      request
        .get("/badroute")
        .expect(404)
        .then(({ body }) => {
  ...
  describe("/api", () => {
    it("statuscode: 200 with appropriate message", () =>
      request
        .get("/api")
        .expect(200)
        .then(({ body }) => {
    ...
    describe("/articles", () => {
      ...
      it("BAD QUERY statuscode:400 author does not exist", () =>
        request
      ...
      it("BAD QUERY statuscode:404 topic does not exist", () =>
        request
      ...
      it("GET status : 200 and returns an array of objects filtered by author", () =>
        request
      ...
      it("GET status : 200 and returns an array of objects filtered by topic", () =>
        request
      ...
      it("GET status : 200 and returns an array of objects sorted by date by default in desc order", () =>
        request
          .get("/api/articles")
          .expect(200)
          .then(res => {
      ...
      it("GET status : 200 and returns an array of objects sorted by a valid column by default in desc order", () =>
        request
      ...
      it("GET status : 200 and returns an array of objects sorted by a valid column by having changed to asc through a query", () =>
        request
    ...
    describe("/articles/:article_id", () => {
      it("BAD REQUEST statuscode:400, when passed a bad query", () =>
        request
      ...
      it("GET status : 200 and returns an array of 1objects", () =>
        request
          .get("/api/articles/1")
          .expect(200)
          .then(res => {
      ...
      it("GET status : 200 and returns an array of 2objects", () =>
        request
          .get("/api/articles/5")
          .expect(200)
          .then(res => {
      ...
      it("PATCH status : 200 and increments vote of article by new vote amount", () =>
        request
      ...
      it("DELETE status : 204 and delete article", () =>
        request
    ...
    describe("/articles/:article_id/comments", () => {
      it("GET status : 400 and returns an array of comments for a given ID", () =>
        request
      ...
      it("GET status : 200 and returns an array of comments for a given ID", () =>
        request
    ...
    describe("/comments/:comments_id", () => {
      ...
      it("PATCH status : 200 and increments vote of a comment by new vote amount", () =>
        request
      ...
      it("DELETE status : 204 and and delete article", () =>
        request
    ...
    describe("/users/:username", () => {
      it("GET status : 200 returns an user object", () =>
        request
      ...
      it("GET status : 422 returns a UNPROCESSED ENTITY error essage", () =>
        request
          .get("/api/users/kars")
          .expect(422)
          .then(({ body }) => {
